  ...
  var defaults = {
        ...
        return this.each(function () {
          ...
          if (settings.options.sniffHtml) {
            ...
            if ($this.attr('max') !== undefined || $this.attr('aria-valuemax') !== undefined) {
              var max =
                $this.attr('max') !== undefined ? $this.attr('max') : $this.attr('aria-valuemax')
              message =
                "Too high: Maximum of '" + max + "'<!-- data-validation-max-message to override -->"
            ...
            if ($this.attr('min') !== undefined || $this.attr('aria-valuemin') !== undefined) {
              var min =
                $this.attr('min') !== undefined ? $this.attr('min') : $this.attr('aria-valuemin')
              message =
                "Too low: Minimum of '" + min + "'<!-- data-validation-min-message to override -->"
          ...
          $.each(validatorNames, function (i, el) {
            ...
            $.each(settings.validatorTypes, function (validatorType, validatorTemplate) {
              ...
              if (
                !foundValidator &&
                $this.data('validation' + el + formatValidatorName(validatorTemplate.name)) !==
                  undefined
              ) {
          ...
          $this.bind(
            ['keyup', 'focus', 'blur', 'click', 'keydown', 'keypress', 'change'].join(
              '.validation ',
            ) + '.validation',
            function (e, params) {
              var value = getValue($this)
    ...
    validatorTypes: {
      ...
      minchecked: {
        ...
        validate: function ($this, value, validator) {
          return (
            (validator.elements.filter(':checked').length < validator.minchecked &&
              !validator.negative) ||
            (validator.elements.filter(':checked').length >= validator.minchecked &&
              validator.negative)
          )
